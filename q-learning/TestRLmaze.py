...
[Q,policy] = rlProblem.qLearning_sarsa(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=200,nSteps=100,epsilon=0.05)
print_policy_word(policy, epsilon=0.05)
print ("\nQ-learning results")
print (Q)
print (policy)

def generate_data_and_plot(nEpisodes=200, nTrials=100, nSteps=100, use_sarsa=False, use_epsilon=None):
    cumulative_reward = np.zeros([nTrials, nEpisodes])
    if use_epsilon is None:
        avg_cumulative_reward = np.zeros([4, nEpisodes])
    else:
        avg_cumulative_reward = np.zeros([1, nEpisodes])
    plot_legend = []
    if use_epsilon is None:
        for epsilon_idx,epsilon_val in enumerate(list([0.05, 0.1, 0.3, 0.5])):
            ...
            for trial in range(nTrials):
                ...
                if not use_sarsa:
                    ...
                    [Q,policy] = rlProblem.qLearning_sarsa(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=nEpisodes,nSteps=nSteps,epsilon=epsilon_val)
...
# #generate data for 200 episodes over 100 trials with qLearning sarsa update
# avg_cumulative_reward, plot_legend = generate_data_and_plot(use_sarsa=True)
# #plot original graph and using moving average for qLearning with sarsa update
# plot_filename = "avg_cumulative_reward_q_learning_sarsa.png"
# plot_title = "Q-Learning: Original Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, use_ax_limit=False)
# plot_filename = "smooth_n5_avg_cumulative_reward_q_learning_sarsa.png"
# plot_title = "Q-Learning: Smooth(n=5) Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, n=5, smooth=True, use_ax_limit=False)
# plot_filename = "smooth_n10_avg_cumulative_reward_q_learning_sarsa.png"
# plot_title = "Q-Learning: Smooth(n=10) Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, n=10, smooth=True, use_ax_limit=False)
# plot_filename = "smooth_n20_avg_cumulative_reward_q_learning_sarsa.png"
# plot_title = "Q-Learning: Smooth(n=20) Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, n=20, smooth=True, use_ax_limit=False)
# plot_filename = "smooth_n50_avg_cumulative_reward_q_learning_sarsa.png"
# plot_title = "Q-Learning: Smooth(n=50) Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, n=50, smooth=True, use_ax_limit=False)


def generate_comparison_data(nEpisodes=200, nTrials=100, nSteps=100, epsilon=0.05):
    cumulative_reward = np.zeros([nTrials, nEpisodes])
    avg_cumulative_reward = np.zeros([2, nEpisodes]) #reward for all algorithms being compared
    plot_legend = []
    for trial in range(nTrials):
        #run q-learning
        [Q,policy] = rlProblem.qLearning(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=nEpisodes,nSteps=nSteps,epsilon=epsilon)
        cumulative_reward[trial,:] = rlProblem.get_cumulative_reward()
    avg_cumulative_reward[0,:] = np.mean(cumulative_reward, axis=0)
    plot_legend.append('q_learning')
    for trial in range(nTrials):
        #run q-learning with sarsa update
        [Q,policy] = rlProblem.qLearning_sarsa(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=nEpisodes,nSteps=nSteps,epsilon=epsilon)
        cumulative_reward[trial,:] = rlProblem.get_cumulative_reward()
    avg_cumulative_reward[1,:] = np.mean(cumulative_reward, axis=0)
    plot_legend.append('q_learning w/ SARSA')

    return avg_cumulative_reward, plot_legend

# #generate data for 200 episodes over 100 trials with qLearning and qLearning sarsa update
# avg_cumulative_reward, plot_legend = generate_comparison_data()
# #plot original graph and using moving average for qLearning with sarsa update
# plot_filename = "avg_cumulative_reward_q_learning_compare.png"
# plot_title = "Q-Learning: Original Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, use_ax_limit=False)
# plot_filename = "smooth_n50_avg_cumulative_reward_q_learning_compare.png"
# plot_title = "Q-Learning: Smooth(n=50) Average Cumulative Reward"
# plot_avg_cumulative_reward(avg_cumulative_reward, plot_legend, plot_title, plot_filename, n=50, smooth=True, use_ax_limit=False)
